...
def test_dictionary_of_metric():
    ...
    assert group_19_module.dictionary_of_metrics([1,2,3,4,5])=={'mean':3.0,'median':3, 'std': 1.41,'variance':2.0,'max':5,'min':1}
    assert group_19_module.dictionary_of_metrics([7, 8, 5, 2, 5, 9, 5, 4, 8, 6])=={'mean': 5.9, 'median': 5.5, 'std': 2.02, 'variance': 4.09, 'max': 9, 'min': 2}
